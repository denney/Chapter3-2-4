 ...
 */
public class UmRolePK implements Serializable {
    private int umId;
    ...
    public boolean equals(Object o) {
        ...
        UmRolePK umRolePK = (UmRolePK) o;

        if (umId != umRolePK.umId) return false;
        if (umTenantId != umRolePK.umTenantId) return false;
