 ...
 */
public class UmClaimPK implements Serializable {
    private int umId;
    ...
    public boolean equals(Object o) {
        ...
        UmClaimPK umClaimPK = (UmClaimPK) o;

        if (umId != umClaimPK.umId) return false;
        if (umTenantId != umClaimPK.umTenantId) return false;
