 ...
 */
public class RegTagPK implements Serializable {
    private int regId;
    ...
    public boolean equals(Object o) {
        ...
        RegTagPK regTagPK = (RegTagPK) o;

        if (regId != regTagPK.regId) return false;
        if (regTenantId != regTagPK.regTenantId) return false;
