 ...
 */
public class UmUserPK implements Serializable {
    private int umId;
    ...
    public boolean equals(Object o) {
        ...
        UmUserPK umUserPK = (UmUserPK) o;

        if (umId != umUserPK.umId) return false;
        if (umTenantId != umUserPK.umTenantId) return false;
